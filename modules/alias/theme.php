...
{
    global $module_info, $lang_module, $db, $module_name,$module_upload , $page_title, $per_page, $page;
    ...
    foreach ($result_array as $result) {
		$result['image'] = NV_BASE_SITEURL . NV_UPLOADS_DIR . '/' . $module_upload . '/' . $result['image'];
